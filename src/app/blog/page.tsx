...
export const metadata: Metadata = {
  title: 'Blog',
  description: 'Event planning tips, menu ideas, and catering advice from Los Angeles Catering and Bar.',
};

const SITE_DOMAIN = 'losangelescateringandbar.com';
    ...
    <>
      <section className="bg-gradient-to-br from-orange-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 text-lg">Event planning tips, menu ideas, and catering advice.</p>
        </div>
      </section>

      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-12 text-center">Latest Catering Tips and Event Ideas</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <p className="text-sm text-orange-600 mb-2">{post.date} • {post.category}</p>
