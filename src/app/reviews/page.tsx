...
export const metadata: Metadata = {
  title: "Leave a Review | Los Angeles Catering and Bar",
  description: "Leave Los Angeles Catering and Bar a review on Google or Yelp.",
};

const reviews = [
  { label: "Leave a Google Review", href: "https://g.page/r/CTayBcUylHLOEAE/", kind: "google" },
  { label: "Leave a Yelp Review", href: "https://www.yelp.com/biz/los-angeles-catering-and-bar-san-fernando-valley", kind: "yelp" },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Los Angeles Catering and Bar and helps us keep improving.
        </p>
