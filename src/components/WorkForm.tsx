...
const inputClass =
  'w-full px-4 py-3 border border-gray-300 rounded text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500';
  ...
  if (status === 'success') {
    return (
      <div className="text-center">
        ...
        <h3 className="mt-3 text-2xl font-serif text-gray-900">You&apos;re on the list!</h3>
        <p className="mt-3 text-gray-600">
          Thanks, {formData.name.split(' ')[0]}! Your details are in. Local catering and event
          companies that are hiring will reach out to you directly.
        </p>
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          id="message"
          rows={3}
          placeholder="e.g. Available weekends, have my own transportation, ServSafe certified…"
      ...
      <button
        ...
        className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded font-medium transition-colors disabled:opacity-60"
      >
